       ...
       fs.readdir(folderPath, (err, files) => {
         ...
         if (latestFile) {
           ...
           if (checker.bestMatch.rating >= 0.5) {
            ...
            api.sendMessage({
  body: `⚠️ 𝗞𝗛𝗢̂𝗡𝗚 𝗧𝗜̀𝗠 𝗧𝗛𝗔̂́𝗬 𝗟𝗘̣̂𝗡𝗛  
👤 𝗕𝗮̣𝗻: ${name}  
🔍 𝗟𝗲̣̂𝗻𝗵 𝗴𝗮̂̀𝗻 đ𝘂́𝗻𝗴: 「 ${checker.bestMatch.target} 」  
📞 𝗟𝗶𝗲̂𝗻 𝗵𝗲̣̂ 𝗔𝗱𝗺𝗶𝗻 𝗻𝗲̂́𝘂 𝗰𝗮̂̀𝗻!  
⏳ 𝗨𝗽𝘁𝗶𝗺𝗲: ${h}:${p}:${s} | ⏰ ${gio}  
━━━━━━━━━━━━━━━`,
  attachment: global.lekhanh.length > 0 ? global.lekhanh.splice(0, 1) : null
}, threadID, async (err, info) => {
  /* Chờ 15 giây rồi gỡ tin nhắn (nếu cần) */
